...
export const v4DopplerQuoterAbi: Abi = [
  {
    type: 'constructor',
    inputs: [
      { name: 'poolManager_', type: 'address', internalType: 'contract IPoolManager' },
      { name: 'stateView_', type: 'address', internalType: 'contract IStateView' },
    ],
